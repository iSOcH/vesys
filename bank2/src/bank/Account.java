...
public interface Account {
	 ...
	 * been removed is always zero. An <code>InactiveException</code> is never
	...
	/**
	 * Changes the State (Active/Inactive) of this account
	 * @param active the new state
	 * @return true, if the state changed, false otherwise
	 */
	boolean setActive(boolean active) throws IOException;
}
